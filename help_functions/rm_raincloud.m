...
function h = rm_raincloud(data, colours, plot_top_to_bottom, density_type, bandwidth, colour_scheme,yfit)
...
colour_scheme_individual_lines = brewermap(10, 'Greys');
...
if n_plots_per_series == 2
    hold on
    %     for i = 1:length(data{1,1})
    %         col_lin = line([h.s{1}.XData(1,i) h.s{2}.XData(1,i)]', [h.s{1}.YData(1,i), h.s{2}.YData(1,i)]');
    %         col_lin.Color = colour_scheme(5,:);
    % %         col_lin.Color = [.8 .8 .8];
    %         col_lin.LineWidth = 1;
    %     end
    for i = 1:length(data{1,1})
        hold on
        col_lin = line([yfit(i,1), yfit(i,2)]', [h.s{1}.YData(1,i) h.s{2}.YData(1,i)]');
        %         col_lin.Color = colour_scheme(5,:);
        col_lin.Color = [.8 .8 .8];
        col_lin.LineWidth = 1;
    end
elseif n_plots_per_series == 3
    %     for i = 1:length(data{1,1})
    %         hold on
    %         col_lin = line([h.s{1}.XData(1,i) h.s{2}.XData(1,i) h.s{3}.XData(1,i)]', [h.s{1}.YData(1,i), h.s{2}.YData(1,i), h.s{3}.YData(1,i)]');
    %         col_lin.Color = colour_scheme(5,:);
    % %         col_lin.Color = [.8 .8 .8];
    %         col_lin.LineWidth = 1;
    %     end
    for i = 1:length(data{1,1})
        hold on
        col_lin = line([yfit(i,1), yfit(i,2), yfit(i,3)]', [h.s{1}.YData(1,i), h.s{2}.YData(1,i), h.s{3}.YData(1,i)]');
        %         col_lin.Color = colour_scheme(5,:);
        col_lin.Color = [.8 .8 .8]
        col_lin.LineWidth = 1;
    end
    elseif n_plots_per_series == 8
    for i = 1:length(data{1,1})
        hold on
        col_lin = line([h.s{1}.XData(1,i), h.s{2}.XData(1,i), h.s{3}.XData(1,i), h.s{4}.XData(1,i),...
            h.s{5}.XData(1,i), h.s{6}.XData(1,i), h.s{7}.XData(1,i), h.s{8}.XData(1,i)]'...
            ,[h.s{1}.YData(1,i), h.s{2}.YData(1,i), h.s{3}.YData(1,i), h.s{4}.YData(1,i)...
            ,h.s{5}.YData(1,i), h.s{6}.YData(1,i), h.s{7}.YData(1,i), h.s{8}.YData(1,i)]');
        col_lin.Color = colour_scheme(i,:);
        %         col_lin.Color = [.8 .8 .8];
        col_lin.LineWidth = 1;
    end
    %           for i = 1:length(data{1,1})
    %         hold on
    %         col_lin = line([yfit(i,1), yfit(i,2), yfit(i,3), yfit(i,4) , yfit(i,5) , yfit(i,6) , yfit(i,7) , yfit(i,8)]', [h.s{1}.YData(1,i), h.s{2}.YData(1,i), h.s{3}.YData(1,i), h.s{4}.YData(1,i), h.s{5}.YData(1,i), h.s{6}.YData(1,i), h.s{7}.YData(1,i), h.s{8}.YData(1,i)]');
    % %         col_lin.Color = colour_scheme(5,:);
    %         col_lin.Color = [.8 .8 .8];
    %         col_lin.LineWidth = 1;
    %       end
